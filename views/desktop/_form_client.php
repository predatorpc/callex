...
<div class="clients-form">
    ...
    <div class="col-md-3">
        ...
        <?= Html::a('Позвонить клиенту', '#', ['class'=>'btn btn-success', 'rel'=>'100', 'onclick'=>'call('.((Yii::$app->user->id==3003161 || Yii::$app->user->id==7831)?"9237042936":$model->phone).','.(!empty(\app\models\Users::find()->where(['id'=>Yii::$app->user->id])->one()->phone_id)?\app\models\Users::find()->where(['id'=>Yii::$app->user->id])->one()->phone_id:'0').');'])?>
    </div>
        <div class="col-md-3">
