...
class CommentsSearch extends Comments
{
    ...
    {
        $query = Comments::find()->select('count(comments.id) as count,comments.created_by_user')->leftJoin('clients','clients.id = comments.client_id')->leftJoin('users','users.id = comments.created_by_user')->groupBy('comments.created_by_user');
